...
public class Ch04Ex01 {
   ...
   public static void main(String[] args) {
      ...
      //4월 10일 부터 12월 31일 까지는 265일 남았습니다.
      //4월 날짜수 - day + ( 5월 + 6월 + 7월 + 8월 + 9월 + 10월 +
      total = days[month-1] - day;
      for(int i = month; i<12; i++) {
    	  total += days[i];
      }
      out.printf("%d월%d일부터 12월 31일까지는 %d일 남앗습니다..\n", month, day, total);
      
      //과제:
      //4월 10일의 100일 후는 ?월 ?일 입니다.
      //단 12월 이상이면 다시 1월부터 돌아가게 한다.
      //Calendar클래스나 Date클래스 사용하지 말것.
      //윤달 없음.
      //오로지 반복문과 배열만 사용해서 연습한다.
